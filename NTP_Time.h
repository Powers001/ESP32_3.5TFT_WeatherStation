...
// TimeChangeRule  Name        Week  Day  Month  Hour  Offset (minutes from UTC)
TimeChangeRule NZDT = {"NZDT", Last, Sun, Sep, 2,  780};   // Daylight Saving Time (UTC+13)
TimeChangeRule NZST = {"NZST", First, Sun, Apr, 3,  720};   // Standard Time (UTC+12)
Timezone NZ(NZDT, NZST);
